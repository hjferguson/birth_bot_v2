...
I am using a file called credentials.py (git version requires your own credentials) to store my information so you could do the same, or directly add to the program.py.
